...
## Categories
Pages are organized by 5 orthogonal categories — each answers a different question:
...
| `guide` | HOW do you work with it? | Patterns, conventions, coding standards, workflows, environment setup |
...
- Wiki pages are tracked by git by default (`.omc/wiki/` is committed with the project)
