...
| File | Skill | Purpose |
|-----------|-------|---------|
| (removed) | ~~autopilot~~ | Deleted — user prefers ralph + explicit requirements |
...
"ralph fix the login bug"  # Triggers ralph skill
```
...
|----------|--------|------------------|
| Execution | ultrawork, ralph, team, ultraqa | "ulw", "ralph", "team" |
...
|-------|----------------------|
| ralph | "ralph", "don't stop until", "must complete" |
